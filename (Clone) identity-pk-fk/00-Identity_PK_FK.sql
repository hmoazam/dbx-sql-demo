...
-- MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=DBSQL&org_id=1444828305810485&notebook=%2F00-Identity_PK_FK&demo_name=identity-pk-fk&event=VIEW&path=%2F_dbdemos%2FDBSQL%2Fidentity-pk-fk%2F00-Identity_PK_FK&version=1">

-- COMMAND ----------

-- MAGIC %md 
-- MAGIC ### A cluster has been created for this demo
-- MAGIC To run this demo, just select the cluster `dbdemos-identity-pk-fk-hanna_moazam` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/0610-115257-o1mdpvkd/configuration)). <br />
...
-- DBTITLE 1,Clean Up
-- %python spark.sql(f"DROP DATABASE {catalog}.{database} CASCADE")
