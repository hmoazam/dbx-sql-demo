...
CREATE OR REPLACE TABLE uc_demos_hanna_moazam.default.fact_sales(  
  ...
  product_id BIGINT NOT NULL CONSTRAINT dim_product_fk FOREIGN KEY REFERENCES uc_demos_hanna_moazam.default.dim_product(product_id_column),  
  store_id BIGINT NOT NULL CONSTRAINT dim_store_fk FOREIGN KEY REFERENCES uc_demos_hanna_moazam.default.dim_store(store_id_column),  
  customer_id BIGINT NOT NULL CONSTRAINT dim_customer_fk FOREIGN KEY REFERENCES uc_demos_hanna_moazam.default.dim_customer(customer_id_column),  
  price_sold DOUBLE,  
  units_sold INT,  
  dollar_cost DOUBLE  
);  
